...
urlpatterns = [
    ...
    path("admin_dashboard", views.admin,name="adminHome"),
    path('estudiante_dashboard/', views.estudiante_dashboard, name='estudiante_dashboard'),
    path('matricular_curso_estudiante/<str:codigo_curso>/', views.matricular_curso_estudiante, name='matricular_curso_estudiante'),
    ...
    path('ver_matriculas_estudiante/', views.ver_matriculas_estudiante, name='ver_matriculas_estudiante'),
    path('desmatricular_curso/', views.desmatricular_curso, name='desmatricular_curso'),
    ]
